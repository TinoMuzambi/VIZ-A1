...
streams.loudness.dance <- tm_shape(world.data, title = "Streams") +
   tm_fill("streams", title = "Streams", palette = "Greens", breaks = breaks) +
  tm_shape(world.data) +
  tm_bubbles("loudness", col = "danceability", 
             style="fixed", breaks=c(0, 0.33, 0.66, 1),
             size = 0.2,
             palette="Blues", contrast=1, 
             title.size="Loudness", 
...
```{r}
streams.liveness.dance <- tm_shape(world.data, title = "Streams") +
   tm_fill("streams", title = "Streams", palette = "Greens", breaks = breaks) +
  tm_shape(world.data) +
  tm_bubbles("liveness", col = "danceability", 
             style="fixed", breaks=c(0, 0.33, 0.66, 1),
             size = 0.2,
             palette="Blues", contrast=1, 
             title.size="Liveness", 
