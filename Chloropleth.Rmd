...
streams.energy.loud.dance <- tm_shape(world.data, title = "Streams") +
  ...
  tm_layout(frame = FALSE, legend.position = c("left", "center"), legend.show = F, inner.margins = 0,  bg.color = "#00000000", aes.color = "#00000000")
streams.energy.loud.dance

tmap_save(streams.energy.dance, filename = "./plots/Chloropleth Bubbles.png", dpi = 1500, scale = 2, device = png)
```
...
sa.streams.energy.loud.dance <- tm_shape(sa.data, title = "Streams") +
  ...
  tm_layout(frame = FALSE, legend.position = c("left", "center"), legend.show = F, inner.margins = 0)
